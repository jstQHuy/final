...
- When the code snippet is incomplete, readme file lacks necessary explanations, or the comments are missing or ambiguous, the confidence must be lowered (Confidence ≤ 3)
**Conclusion Constraints**:
- If ANY of your discovery matches the listed indicators, the conclusion should be true
"""
